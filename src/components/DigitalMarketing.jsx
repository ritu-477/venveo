  ...
  return (
    <div className="lg:py-[66px] md:py-12 py-6 relative">
      ...
      <div className="container">
          ...
          />
          <p className="font-normal text-custom-lg leading-5 font-maisonMono sm:pt-[22px] pt-5 text-center max-w-[293px] sm:max-w-[641px] mx-auto">
          ...
          <div className="sm:pt-[83px] pt-[92px] max-w-[1072px] mx-auto">
            ...
            {!showAll && (
              <div className="flex justify-center mt-12 sm: sm:hidden">
                <button
                  className="font-semibold text-custom-lg leading-custom-lg"
                  onClick={() => setShowAll(true)}
                >
                  Show More Solutions <span className='text-custom-sm leading-custom-xs'>▼</span>
                </button>
              </div>
            )}
          </div>
